...
export default function IdolsPage() {
  const products = productsData.filter(p => p.category.toLowerCase() === "idols");

  return (
    <div className="flex flex-col w-full bg-white min-h-screen">
      <div className="container mx-auto px-4 md:px-8 py-20 pb-12 flex-grow">
        <div className="text-center mb-16">
          <h1 className="text-4xl font-serif uppercase tracking-widest text-[#546247] mb-4">Idols</h1>
        ...
        {products.length === 0 ? (
          <div className="text-center text-gray-500 py-20 bg-gray-50 rounded-sm border border-gray-100">
            <p>More Idols products coming soon.</p>
      ...
      <SuggestedProducts currentCategory="Idols" />
    </div>
  );
}
