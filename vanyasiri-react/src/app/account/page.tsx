                ...
                <div className="w-full md:w-1/2 p-8 md:p-12 lg:p-16">
                    ...
                    <form onSubmit={handleAuth} className="space-y-6">
                        ...
                        <button
                            type="submit"
                            disabled={isLoading}
                            className={`w-full bg-[#546247] hover:bg-[#435038] text-white py-4 mt-4 text-sm uppercase tracking-[0.1em] font-medium transition-colors shadow-md ${isLoading ? "opacity-70 cursor-not-allowed" : ""}`}
                        >
                            {isLoading ? "Please wait..." : (isRegistering ? "Register Now" : "Secure Sign In")}
                        </button>
                    </form>
