                    ...
                    {items.map((item) => (
                        <div key={item.id} className="flex flex-col sm:flex-row items-center gap-6 p-6 bg-white shadow-sm border border-gray-100">
                            ...
                            <div className="flex-grow text-center sm:text-left">
                                ...
                                <p className="text-[#B38F52] font-semibold text-sm">₹{formatPrice(item.price)}</p>
                            </div>
                            ...
                            <div className="hidden sm:block text-right w-24">
                                <span className="font-bold text-[#2A2E26]">₹{formatPrice((item.price || 0) * item.quantity)}</span>
                            </div>
                        </div>
                    ))}
                </div>
