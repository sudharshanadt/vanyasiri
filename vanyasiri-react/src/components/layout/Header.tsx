                                            ...
                                            return (
                                                <li key={p.id}>
                                                    ...
                                                    >
                                                        ...
                                                        <span className="text-sm font-semibold text-[#B38F52] whitespace-nowrap">₹{formatPrice(p.price)}</span>
                                                    </Link>
                                                </li>
                                            );
                                        })}
                                ...
                                {searchResults.map(p => (
                                    <li key={p.id}>
                                        ...
                                        >
                                            ...
                                            <span className="text-sm font-semibold text-[#B38F52]">₹{formatPrice(p.price)}</span>
                                        </Link>
                                    </li>
                                ))}
                            </ul>
