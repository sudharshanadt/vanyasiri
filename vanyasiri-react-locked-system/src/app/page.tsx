      ...
      <section className="flex flex-col md:flex-row w-full bg-[#1F3C6D] text-white relative">
        ...
        <div className="w-full md:w-1/2 p-12 md:p-20 flex flex-col justify-center">
          ...
          <div className="flex gap-4">
            ...
            <Link href="/shop/rasashala" className="inline-block border border-[#B38F52] text-[#B38F52] hover:bg-[#B38F52] hover:text-[#1F3C6D] px-8 py-3 text-sm uppercase tracking-wider transition-colors font-medium">
              Shop Rasashala
            </Link>
          </div>
        </div>
